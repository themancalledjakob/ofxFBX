...
//----------------------------------------------------------------
void ofxFBXSkeleton::getSkeleton(vector <string> & drawBoneNames, ofPolyline & skeleton){
//    transformGL(); {
    root->getSkeleton(drawBoneNames, skeleton);
//    } restoreTransformGL();
}
//----------------------------------------------------------------
void ofxFBXSkeleton::draw(float aLen, bool aBDrawAxes, vector <string> & drawBoneNames){
//    transformGL(); {
    root->draw(aLen, aBDrawAxes, drawBoneNames);
//    } restoreTransformGL();
}
